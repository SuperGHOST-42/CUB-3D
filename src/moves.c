...
/*   Updated: 2026/05/04 00:05:34 by arpereir         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	move_left(t_game *game)
{
	...
	speed = SPEED;
	new_x = game->player.x - (game->player.fov_x * speed);
	new_y = game->player.y - (game->player.fov_y * speed);
	if (can_move(game, new_x, game->player.y))
		game->player.x = new_x;
	if (can_move(game, game->player.x, new_y))
		game->player.y = new_y;
...
void	rotate_left(t_game *game)
{
	...
	game->player.fov_y = old_plane_x * sin(rot_speed)
